---
title: "GSAP Skill: GSAP Timeline & Sequences"
tags: [gsap, animation, greensock, gsap-timeline, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP Timeline & Sequences

> **Имя скилла:** `gsap-timeline`  
> **Локальный путь:** `/root/.agent/skills/gsap-timeline/SKILL.md`  
> **Описание:** Создание сложных временных шкал, таймлайнов, цепочек анимаций и мастер-таймлайнов.
