---
title: "GSAP Skill: GSAP React & useGSAP"
tags: [gsap, animation, greensock, gsap-react, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP React & useGSAP

> **Имя скилла:** `gsap-react`  
> **Локальный путь:** `/root/.agent/skills/gsap-react/SKILL.md`  
> **Описание:** Официальный хук useGSAP(), очистка контекста, работа с ref, SSR и React 18+.
