---
title: "GSAP Skill: GSAP Core Engine"
tags: [gsap, animation, greensock, gsap-core, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP Core Engine

> **Имя скилла:** `gsap-core`  
> **Локальный путь:** `/root/.agent/skills/gsap-core/SKILL.md`  
> **Описание:** Базовый движок GreenSock, твины gsap.to(), gsap.from(), gsap.fromTo(), easings и свойства.
