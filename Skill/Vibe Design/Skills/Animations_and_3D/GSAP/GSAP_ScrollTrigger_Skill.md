---
title: "GSAP Skill: GSAP ScrollTrigger"
tags: [gsap, animation, greensock, gsap-scrolltrigger, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP ScrollTrigger

> **Имя скилла:** `gsap-scrolltrigger`  
> **Локальный путь:** `/root/.agent/skills/gsap-scrolltrigger/SKILL.md`  
> **Описание:** Анимации при скролле, параллакс, прилипание (pinning), скраббинг (scrub) и триггеры элементов.
