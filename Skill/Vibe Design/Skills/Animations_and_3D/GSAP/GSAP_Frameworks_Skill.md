---
title: "GSAP Skill: GSAP Frameworks & Webflow"
tags: [gsap, animation, greensock, gsap-frameworks, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP Frameworks & Webflow

> **Имя скилла:** `gsap-frameworks`  
> **Локальный путь:** `/root/.agent/skills/gsap-frameworks/SKILL.md`  
> **Описание:** Интеграция GSAP в Webflow, Next.js, Vue, Svelte, Nuxt и Vanilla HTML/JS.
