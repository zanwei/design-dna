---
title: "GSAP Skill: GSAP Performance & 60fps"
tags: [gsap, animation, greensock, gsap-performance, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP Performance & 60fps

> **Имя скилла:** `gsap-performance`  
> **Локальный путь:** `/root/.agent/skills/gsap-performance/SKILL.md`  
> **Описание:** Оптимизация производительности до 60/120 fps, ускорение GPU, will-change и предотвращение утечек памяти.
