---
title: "GSAP Skill: GSAP Premium Plugins"
tags: [gsap, animation, greensock, gsap-plugins, vibe-design]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Skills/GSAP"
---

# ⚡ GSAP Skill: GSAP Premium Plugins

> **Имя скилла:** `gsap-plugins`  
> **Локальный путь:** `/root/.agent/skills/gsap-plugins/SKILL.md`  
> **Описание:** Плагины SplitText, MorphSVG, Flip, Observer, DrawSVG, MotionPath и Draggable.
