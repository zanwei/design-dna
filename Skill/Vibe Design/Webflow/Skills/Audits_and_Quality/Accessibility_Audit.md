---
title: "Webflow Skill: Accessibility Audit"
tags: [webflow, mcp, skill, accessibility-audit]
date: 2026-07-29
status: ✅ Активен
category: "Vibe Design/Webflow/Skills"
---

# 🛠️ Webflow Skill: Accessibility Audit

> **Имя скилла:** `accessibility-audit`  
> **Локальный путь:** `/root/.agent/skills/accessibility-audit/SKILL.md`
