...
tags: [figma, webflow, client-first, mcp, design-to-code, flowkit, vibe-design, pipeline, general]
date: 2026-07-30
status: ✅ Активен
category: "General"
---
...
Официальный регламент переноса дизайна из **Figma** в **Webflow** с использованием двух MCP-серверов (**Figma MCP** + **Webflow MCP**) и методологии верстки **Finsweet Client-First**.
...
2. **Семантика слоев**: Фреймы называют понятными именами (`Header`, `Hero`, `Features`, `Card`, `Footer`).
