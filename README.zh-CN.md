...
![示例：根据感知样式与测量令牌重建 bun.sh 首屏。测量重建复现了所有令牌（验证通过，平均 ΔE 0.87）；感知重建将近黑色背景偏移为 #000000，并将品牌粉色偏移为常见的 #ec4899（验证失败，平均 ΔE 9.54）。](docs/example-deterministic-measurement.png)
